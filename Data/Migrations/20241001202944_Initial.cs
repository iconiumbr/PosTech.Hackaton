        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_ZipCode = table.Column<string>(type: "varchar(8)", nullable: true),
                    ...
                    ContactNumber = table.Column<string>(type: "varchar(12)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<int>(type: "int", nullable: true),
                    MorningStartHour = table.Column<TimeSpan>(type: "time", nullable: false),
                    MorningEndHour = table.Column<TimeSpan>(type: "time", nullable: false),
                    AfternoonStartHour = table.Column<TimeSpan>(type: "time", nullable: false),
                    AfternoonEndHour = table.Column<TimeSpan>(type: "time", nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Contact = table.Column<string>(type: "varchar(15)", nullable: true),
                    DoctorId = table.Column<int>(type: "int", nullable: true),
